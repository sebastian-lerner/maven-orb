...
cat .circleci/tests/surefire_classnames | circleci tests run --command=">/tmp/this_node_tests xargs echo" --split-by=timings --timings-type=classname --verbose 
...
cat .circleci/tests/failsafe_classnames | circleci tests run --command=">/tmp/this_node_it_tests xargs echo" --split-by=timings --timings-type=classname --verbose
